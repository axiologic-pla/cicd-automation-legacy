...
echo $FOLDER_PATH
git clone https://github.com/pharmaledgerassoc/acdc-components.git $FOLDER_PATH
...
helm upgrade --install --wait --timeout=600s dfm-backend pharmaledgerassoc/dfm-backend
